...
<span style="color: #ADD8E6;">_Story Line:_</span>
...
- Use Tkinter and MySQL Python connector, On booking a ticket check the available options and choose the flight
...
**<span style="color: #ADD8E6; font-size: 1rem;">Authors - Kaushik Kumbhat and Shyam Prasath</span>**
...
- **For example:** ```double salary = balance[9];``` The above statement will take the 10th element from the array and assign the value to the salary variable. 
...
LINK: <http://www.hackerrank.com/preliminary-task-2nd-year>
