...
domain: Open Source
author: Author - Umme Rooman & Manasa
---
<hr>
...
```
_References:_
- [<span style="color: #FFC0CB;">Web Crawling/Scraping Website <p>For example, take this page where we have a lot of information like warning, results etc., and extract the data that we only care about like title, price and availability</span>](https://books.toscrape.com) 
